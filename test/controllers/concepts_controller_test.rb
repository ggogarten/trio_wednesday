...
class ConceptsControllerTest < ActionController::TestCase
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post :create, concept: { idea: @concept.idea, relevance: @concept.relevance, speech_id: @concept.speech_id }
    end
  ...
  test "should update concept" do
    patch :update, id: @concept, concept: { idea: @concept.idea, relevance: @concept.relevance, speech_id: @concept.speech_id }
    assert_redirected_to concept_path(assigns(:concept))
  end
